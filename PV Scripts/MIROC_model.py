...
def load_datasets(year_start, year_end):
    vas_file_path = f'/work/nai5/storage/interpolated/MIROC/data/interpolated_vas_MIROC_{year_start}-{year_end}_grid.nc'
    uas_file_path = f'/work/nai5/storage/interpolated/MIROC/data/interpolated_uas_MIROC_{year_start}-{year_end}_grid.nc'
    ...
    rsds_file_path = f'/work/nai5/storage/interpolated/MIROC/data/interpolated_rsds_MIROC_{year_start}-{year_end}_grid.nc'
...
def main():
    for year in range(2019, 2100, 2):
        year_start = year
        year_end = year + 1
        output_file_path = f'/work/nai5/storage/MIROC_output/MIROC_daily_energy_output_{year_start}-{year_end}.nc'
