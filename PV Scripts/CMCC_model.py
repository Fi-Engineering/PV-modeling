...
def load_datasets(year_start, year_end):
    vas_file_path = f'./vas/CMCC/interpolated/interpolated_vas_CMCC_{year_start}-{year_end}.nc'
    uas_file_path = f'./uas/CMCC/interpolated/interpolated_uas_CMCC_{year_start}-{year_end}.nc'
    tas_file_path = f'./tas/GFDL/interpolated/interpolated_tas_GFDL_{year_start}-{year_end}_grid.nc'
    rsds_file_path = f'./rsds/CMCC/interpolated/interpolated_rsds_CMCC_{year_start}-{year_end}.nc'
    ...
    #land_sea_mask = xr.open_dataset('landseamask_192x288.nc')
...
def main():
    for year in range(2019, 2101, 2):
        year_start = year
        year_end = year + 1
        output_file_path = f'output/daily_energy_output_{year_start}-{year_end}.nc'
        ...
        #print_dataset_info(vas_ds, "VAS")
        #print_dataset_info(uas_ds, "UAS")
        #print_dataset_info(tas_ds, "TAS")
        #print_dataset_info(rsds_ds, "RSDS")
        #print_dataset_info(aligned_apparent_zenith_ds, "Aligned Apparent Zenith")
        #print_dataset_info(aligned_azimuth_ds, "Aligned Azimuth")
        ...
        #print("\nTime points for vas_ds:", vas_time)
        #print("Time points for uas_ds:", uas_time)
        #print("Time points for tas_ds:", tas_time)
        #print("Time points for rsds_ds:", rsds_time)
        #print("Time points for aligned_apparent_zenith_ds:", apparent_zenith_time)
        #print("Time points for aligned_azimuth_ds:", azimuth_time)
