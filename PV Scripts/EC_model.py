...
def load_datasets(year_start, year_end):
    vas_file_path = f'/work/nai5/storage/interpolated/EC/data/interpolated_vas_EC-Earth_{year_start}-{year_end}_grid.nc'
    uas_file_path = f'/work/nai5/storage/interpolated/EC/data/interpolated_uas_EC-Earth_{year_start}-{year_end}_grid.nc'
    ...
    rsds_file_path = f'/work/nai5/storage/interpolated/EC/data/interpolated_rsds_EC-Earth_{year_start}-{year_end}_grid.nc'
...
def main():
    for year in range(2021, 2100, 2):
        year_start = year
        year_end = year + 1
        output_file_path = f'/work/nai5/storage/EC_output/EC-Earth_daily_energy_output_{year_start}-{year_end}.nc'
        #output_dir = '/work/nai5/storage/EC_output/EC-Earth_daily_energy_output_{year_start}-{year_end}.nc'
