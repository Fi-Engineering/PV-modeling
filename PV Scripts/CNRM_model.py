...
def load_datasets(year_start, year_end):
    vas_file_path = f'/work/nai5/storage/interpolated_vas_CNRM_{year_start}-{year_end}_grid.nc'
    uas_file_path = f'/work/nai5/storage/interpolated_uas_CNRM_{year_start}-{year_end}_grid.nc'
    ...
    rsds_file_path = f'/work/nai5/storage/interpolated_rsds_CNRM_{year_start}-{year_end}_grid.nc'
...
def main():
    for year in range(2073, 2100, 2):
        year_start = year
        year_end = year + 1
        output_file_path = f'output/CNRM/CNRM_daily_energy_output_{year_start}-{year_end}.nc'
