...
def load_datasets(year_start, year_end):
    vas_file_path = f'/work/nai5/storage/interpolated/IPSL/data/interpolated_vas_IPSL_{year_start}-{year_end}_grid.nc'
    uas_file_path = f'/work/nai5/storage/interpolated/IPSL/data/interpolated_uas_IPSL_{year_start}-{year_end}_grid.nc'
    ...
    rsds_file_path = f'/work/nai5/storage/interpolated/IPSL/data/interpolated_rsds_IPSL_{year_start}-{year_end}_grid.nc'
...
def main():
    for year in range(2095, 2100, 2):
        year_start = year
        year_end = year + 1
        output_file_path = f'/work/nai5/storage/IPSL_output/IPSL_daily_energy_output_{year_start}-{year_end}.nc'
